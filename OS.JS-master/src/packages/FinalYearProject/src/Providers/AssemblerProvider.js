...
export const assemblerContext = createContext()


function AssemblerProvider(props) {
    ...
    const [assembler,setAssembler] = useState(()=>{
        return{
            go: function (input) {
                ...
                // Allowed registers: AL, BL, CL, DL, SP
    ...
    return (
        <assemblerContext.Provider value={assembler}>
            {props.children}
        </assemblerContext.Provider>
    );
}

export default AssemblerProvider;
